CREATE TABLE [dbo].[Products] (
    ...
    ProductCategoryId INT NOT NULL, -- EN: Foreign key reference to the product category | ES: Referencia a la tabla de categorías de productos
    Barcode NVARCHAR(50), -- EN: Barcode of the product (if applicable) | ES: Código de barras del producto (si aplica)
