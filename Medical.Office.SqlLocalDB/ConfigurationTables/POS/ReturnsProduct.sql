...
(
    ...
    ReturnStatusId INT NOT NULL, -- EN: Foreign key reference to the return status | ES: Referencia al estado de la devolución
    FOREIGN KEY (SaleId) REFERENCES Sales(SaleId),
    FOREIGN KEY (ReturnStatusId) REFERENCES ReturnStatuses(ReturnStatusId)
);